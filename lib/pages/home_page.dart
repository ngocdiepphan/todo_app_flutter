...
import 'package:todo_app_flutter/components/td_bottom_bar.dart';
import 'package:todo_app_flutter/pages/login_page.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  _getTodos() {
    if (_todos.isEmpty) {
      _prefs.getTodos().then((value) {
        _todos = globals.todos = value ?? todosInit;
      });
    }
  ...
  //       if (_todos[i].isDelete = true) {
  //         _deletesItem.add(_todos[i]);
  //       }
  //     }
  //     _searches = [..._deletes];
  //     setState(() {});
